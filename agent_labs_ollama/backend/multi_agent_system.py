...
class MultiAgentSystem:
    ...
    def get_available_tools() -> List[Dict[str, str]]:
        ...
        tools = [
            ...
            {"id": "flight_search", "name": "Flight Search", "description": "Search for flight information between cities on specific dates (provides search guidance, not actual booking)", "short_description": "search for flight information between cities on specific dates", "category": "general"},
            {"id": "hotel_search", "name": "Hotel Search", "description": "Search for hotel accommodations in a specific location with check-in and check-out dates", "short_description": "search for hotel accommodations by location and dates", "category": "general"},
