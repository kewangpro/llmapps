...
class MultiAgentSystem:
    ...
    def get_available_tools() -> List[Dict[str, str]]:
        ...
        tools = [
            ...
            {"id": "flight", "name": "Flight Search", "description": "Search for flight information between cities on specific dates (provides search guidance, not actual booking)", "short_description": "search for flight information between cities on specific dates", "category": "general"},
